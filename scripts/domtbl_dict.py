...
"""
#------------------------------------------------------------------------------
def domtbl_pickledict_build(target, source, env):
    """
    Parse HMMER domain table output into a nested dictionary.
    Save the dictionary as a pickle binary object.
    """
    import pickle

    hit_dict = {}
    with open(source, 'r') as dtblhit:
        for hit in dtblhit:
            hit = hit.rstrip()
